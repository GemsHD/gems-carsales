<template>
    <div class="modal-wrapper" v-if="showModal">
      ...
      <div class="modal-content">
        ...
        <p>
          Are you sure you want to exchange this vehicle "{{ vehiclePlate }}"?
        </p>
...
import axios from 'axios';
  ...
  export default {
    ...
    methods: {
      cancelPurchase() {
        this.$emit('cancel-exchange');
      },
      confirmPurchase() {
        const vehiclePlate = this.vehiclePlate;

        axios.post('https://gems-carsales/confirmExchange', {
            vehiclePlate,
        })
        .then(response => {
