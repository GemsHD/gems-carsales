<template>
    <div class="product-card">
      ...
      <div class="product-info">
        ...
        <div class="product-content">
          <span class="text product-text">Buy Price:</span> <span class="product-text price">${{ product.owner_buy_price.toLocaleString() }}</span>
        </div>
        <div class="product-content">
            <span class="text product-text">Sale Price:</span> <span class="product-text price">${{ product.max_price.toLocaleString() }}</span>
        </div>
        <div class="product-content">
          <span class="text product-text">Stock:</span> <span class="product-text price">{{ product.stock }}</span>
        </div>
